...
A multi-page business website for a BMW specialist repair shop, covering:

- **Home** — hero section, value proposition, trust signals
- **Services** — full breakdown of repair and maintenance offerings
- **Specialist** — team and expertise positioning
- **Media** — photo gallery and shop showcase
- **Community** — local presence and customer connection

Three full design variants (wa, wb, wc) were developed and presented to the client before the final direction was chosen. The rejected variants are preserved in the repo as reusable templates.
...
`HTML` `CSS` `JavaScript` `GitHub Pages` · Custom domain via `bmwrepairshop.net`

## In Progress

- Google Analytics integration for traffic and conversion tracking
- SEO optimization (meta tags, structured data, sitemap)
- Expanded `llms.txt` coverage for broader AI assistant discoverability
